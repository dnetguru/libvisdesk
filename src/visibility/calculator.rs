...
use crate::types::{Inner, WindowInfo};
use crate::visibility::compute_region_area;
use crate::win::{enum_monitors_collect, enum_windows_collect};
...
/// - A vector of (monitor_id, current_visible, max_visible, total_area) tuples
/// - The total visible area across all monitors
/// - The total area across all monitors
pub(crate) fn calculate_visible_desktop_area(inner: &mut Inner) -> (Vec<(i64, i64, i64, i64)>, i64, i64) {
